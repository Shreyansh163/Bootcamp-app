...
import { AuthService, CourseService } from "../../services/authServices";
...
const AdminContent = () => {
  ...
  let handleSubmit = e => {
    ...
    try {
      ...
      console.log(payload);
      CourseService("bootcamps", payload, `Bearer ${user?.token}`)
        .then(data => {
          console.log(data);
          if (data.success) {
            toast.success("succesfully bootcamp created");
...
//! Required fields
// name , description, website, email, address, careers, average rating, average cost, photo, housing, job assistence, job gaurentee.

// import React from 'react'

// const AdminContent = () => {
//   return (
//     <div className='basis-4/5 bg-slate-100'>AdminContent</div>
//   )
// }
